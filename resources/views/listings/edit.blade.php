...
@section('content')
    ...
    <div class="flex items-center justify-center">
        ...
        <x-card class="p-3 md:p-10 mx-4 md:mx-auto md:mt-10">
            ...
            <div class="text-center font-bold uppercase mb-10">
                <h2 class="md:hidden text-lg text-gray-500 dark:text-white">Edit your service info</h2>
            </div>
            ...
            <form method="POST" action="/listings/{{ $listing->id }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <select id="subcategory" name="subcategory_id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        disabled>
                        <option selected value="{{ $listing->subcategory->id }}"> {{ $listing->subcategory->name }}
                        </option>
                    </select>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $listing->description }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <select id="county" disabled name="address_id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-6">
                    <label for="locations_directions" class="inline-block text-lg mb-2 dark:text-gray-200">Buisness
                        directions</label>
                ...
                <div class="mb-6">
                    <label for="reasons_to_choose" class="inline-block text-lg mb-2 dark:text-gray-200">Reasons to
                        choose</label>

                    <textarea id="reasons_to_choose" name="reasons_to_choose" rows="4"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $listing->reasons_to_choose }}</textarea>
                ...
                <div class="mb-6">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input name="warranty" type="checkbox" value="1" class="sr-only peer"
                            @if ($listing->warranty == 1) checked @endif>
                        <div
                ...
                <div class="mb-6">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input id="free_diagnosis" name="free_diagnosis" type="checkbox" value="1" class="sr-only peer"
                            @if ($listing->free_diagnosis == 1) checked @endif>
                        <div
                            class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                        </div>
