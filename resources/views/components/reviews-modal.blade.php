    ...
    <div class="py-12 bg-gray-700/50 transition duration-150 ease-in-out z-10 fixed top-0 right-0 bottom-0 left-0 h-auto w-screen hidden"
        ...
        <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
            <div class="relative mt-5 py-8 px-5 md:px-10 bg-white shadow-md rounded-lg border border-gray-400">
                <h1 class="text-gray-800 text-center text-2xl font-bold tracking-normal leading-tight mb-4">Tell us about
                    your
                    experience!</h1>

                <div class="rating py-10 flex items-center justify-center">
                    <span data-rating="1" class="">
                        <svg aria-hidden="true" class="star w-10 h-10 text-gray-300" fill="currentColor" viewBox="0 0 20 20"
                    ...
                    <span data-rating="2" class="">
                        <svg aria-hidden="true" class="star w-10 h-10 text-gray-300" fill="currentColor"
                    ...
                    <span data-rating="5" class="">
                        <svg aria-hidden="true" class="star w-10 h-10 text-gray-300 dark:text-gray-500" fill="currentColor"
                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
