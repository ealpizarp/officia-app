    ...
    <div class="flex justify-between">
        ...
        <div class="flex flex-col lg:flex-row justify-between gap-x-10">
            <div class="flex w-auto">
                <h3
                    class="flex text-sm lg:text-lg text-center items-center text-zinc-600 hover:text-cyan-600 transition duration-300 font-bold dark:text-gray-200 dark:hover:text-cyan-500">
