...
@section('content')
    <section class="h-full mt-32 mx-10">
        <div class="container mx-auto px-4">
            <div class="relative flex flex-col min-w-0 break-words bg-gray-100 w-full mb-6 shadow-xl rounded-lg dark:bg-gray-500">
                <div class="px-6">
                    ...
                    <div class="text-center mt-28">
                        ...
                        <div class="mb-2 text-gray-500 dark:text-gray-200 font-medium mt-10">
                            <i class="fa-solid fa-envelope mr-2 text-lg text-gray-500 dark:text-gray-200"></i> {{$user->email}}
                        </div>
                        <div class="mb-2 text-gray-500 dark:text-gray-200 font-medium">
